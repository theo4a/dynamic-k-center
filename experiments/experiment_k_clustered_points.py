...
from utils import check_radius, euclidean_distance, hsva_to_rgba, simulate_streaming, write_json, boxplot, generate_clustered_points
...
def experiment_k_clustered_points() -> None:
    ...
    for k in ks:
        ...
        for i in range(sample_size):
            ...
            results[str(k)]["r_prime_DA"].append(da_solution["radius"])
            ...
            results[str(k)]["r_prime_RDA"].append(rda_solution["radius"])
            ...
            results[str(k)]["r_prime_PSA"].append(psa_solution["radius"])
...
def plot_experiment_k_clustered_points() -> None:
    
    file_path = os.path.join(os.path.dirname(__file__), "..", "results", "data", "experiment_k_clustered_points.json")
    ...
    plot_file_path = os.path.join(os.path.dirname(__file__), "..", "results", "plots", "plot_experiment_k_clustered_points.jpg")
